...
const Navbar: React.FC<props> = ({ device, isDarkMode, setIsDarkMode, show, setShow }) => {
    ...
    return (
        <nav className={`${isDarkMode ? "border-b border-dark-icons bg-dark-primary" : "bg-white"} flex items-center justify-between px-5 sm:px-16 h-32 w-full`}>
            ...
            <div className={`${isDarkMode ? "text-white" : ""} hidden lg:flex items-center text-2xl font-medium`}>
                <button className=' px-4 relative group focus:outline-none'>
                    ...
                    <div className='absolute hidden group-focus:block group-hover:block'>
